...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            @Override
            public String say() {
                if (i < 1) return super.getSuperQuotes() + name + super.getSuperQuotes() + " спит.";
                char[] woof = new char[i];
                Arrays.fill(woof, 'а');
                return super.getSuperQuotes() + name + super.getSuperQuotes() + " лает г" + String.valueOf(woof) + "в! "
                        + super.formatter.format(new Date());
            }
        }
